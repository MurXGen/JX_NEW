...
function Register() {
  ...
  const handleRegister = async () => {
    ...
    if (!/^(?=.*[a-zA-Z])(?=.*\d)(?=.*[\W_]).{8,15}$/.test(password)) {
      setPopup({
        message: "Password must be 8–15 chars, include letters, numbers & a special character",
        type: "error"
      });
      return;
    }
  ...
  return (
    <div className="register flexClm gap_32">
      ...
      <div className="s_tit_des flexClm">
        ...
        <span className='des font_14 shade_50'>Your discipline starts here</span>
      </div>
            ...
            <div key="email-step" className="flexClm gap_24">
              ...
              <div className="suggestionInput flexClm">
                ...
                {email && !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(email) && (
                  <span className="font_12 error">Enter a valid email (must include @ and .com)</span>
                )}
          ...
          <div className="flexClm gap_32">
            <div key="password-step" className="flexClm gap_24">
              ...
              <div className="passwordWrap flexClm">
                ...
                {password && !/^(?=.*[a-zA-Z])(?=.*\d)(?=.*[\W_]).{8,15}$/.test(password) && (
                  <span className="font_12 error">
                    Password: 8–15 chars, letters, numbers & 1 special character
                  </span>
                )}
              </div>
