...
export default function Overview({ stats, trades }) {
  ...
  return (
    <div className="overview flexClm gap_32">
      ...
      <div
        className="pnlChart chart_boxBg flexClm gap_24"
        style={{ padding: "16px 16px" }}
      >
      ...
      >
        ...
        <div className="flexRow flexRow_stretch gap_12">
          ...
          >
            ...
            <span
              className={`success stats?.maxProfit >= 0 ? "text-green-500" : "text-red-500"`}
            >
          ...
          >
            ...
            <span
              className={`error stats?.maxLoss < 0 ? "text-red-500" : "text-green-500"`}
            >
